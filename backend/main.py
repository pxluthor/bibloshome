...
from ai_estudio_routes import router as ai_estudio_router
from auto_metadata_routes import router as auto_metadata_router
...
app.include_router(ai_estudio_router)
app.include_router(auto_metadata_router)
